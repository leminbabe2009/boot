...
const handler = async (m, { text, usedPrefix, command }) => {
  // قائمة المدن للاختيار منها
  const rows = [
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الــقــاهــره",
      description: "",
      id: `${usedPrefix + command} القاهره`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الرياض",
      description: "",
      id: `${usedPrefix + command} الرياض`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الدار البيضاء",
      description: "",
      id: `${usedPrefix + command} الدار البيضاء`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "دبي",
      description: "",
      id: `${usedPrefix + command} دبي`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "بيروت",
      description: "",
      id: `${usedPrefix + command} بيروت`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "تونس",
      description: "",
      id: `${usedPrefix + command} تونس`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الجزائر",
      description: "",
      id: `${usedPrefix + command} الجزائر`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "بغداد",
      description: "",
      id: `${usedPrefix + command} بغداد`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "عمان",
      description: "",
      id: `${usedPrefix + command} عمان`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الخرطوم",
      description: "",
      id: `${usedPrefix + command} الخرطوم`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "دمشق",
      description: "",
      id: `${usedPrefix + command} دمشق`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "طرابلس",
      description: "",
      id: `${usedPrefix + command} طرابلس`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "مسقط",
      description: "",
      id: `${usedPrefix + command} مسقط`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الدوحة",
      description: "",
      id: `${usedPrefix + command} الدوحة`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "المنامة",
      description: "",
      id: `${usedPrefix + command} المنامة`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الكويت",
      description: "",
      id: `${usedPrefix + command} الكويت`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "جدة",
      description: "",
      id: `${usedPrefix + command} جدة`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "مكة",
      description: "",
      id: `${usedPrefix + command} مكة`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "المدينة",
      description: "",
      id: `${usedPrefix + command} المدينة`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "الشارقه",
      description: "",
      id: `${usedPrefix + command} الشارقة`,
    },
    {
      header: "⌈ الصلاة اليوم في مدينة: ⌋",
      title: "المغرب",
      description: "",
      id: `${usedPrefix + command} المغرب`,
    },
  ];

  // قائمة الصور للاختيار منها
  const images = [
  ...
  // إذا تم إدخال اسم مدينة، استعلام عن مواقيت الصلاة وإضافتها إلى الرسالة
  if (text) {
    try {
      const prayerResponse = await axios.get(
        `http://api.aladhan.com/v1/timingsByCity?city=${encodeURIComponent(text)}&country=EG`,
      );
      ...
      const mediaMessageWithPrayer = await prepareWAMessageMedia(
        { image: { url: randomImage } },
        { upload: conn.waUploadToServer },
      );
      const msgWithPrayer = generateWAMessageFromContent(
        m.chat,
        {
          viewOnceMessage: {
            message: {
      ...
      await conn.relayMessage(m.chat, msgWithPrayer.message, {
        messageId: msgWithPrayer.key.id,
      });
    } catch (error) {
